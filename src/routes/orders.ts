 ...
 */
router.get('/user/:userId', jwtAuth, async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
router.get('/stats/summary', jwtAuth, async (_req: Request, res: Response, next: NextFunction) => {
  try {
